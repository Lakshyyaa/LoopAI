...
// import { Mail, MailType } from "@/lib/validation/mail";
// import { useAuth } from "@clerk/nextjs";

// export const SyncMailButton = () => {
//   const userId = useAuth();
//   if (!userId) {
//     throw new Error("lol no user found");
//   }
//   const [gapiReady, setGapiReady] = useState(false);
//   const [gisReady, setGisReady] = useState(false);
//   const [messages, setMessages] = useState("");
...
// });
//     }
//     // const createMany = await prisma.mail.createMany({
//     //   data: mailsToCreate,
//     // });
  ...
  function handleAuthClick() {
    ...
    tokenClient.callback = async (resp) => {
      ...
      await listMessages().then(() => {
        console.log("done niga");
        handleSignoutClick();
        console.log("done aaaaaniga");
        router.refresh();
      });
    };
